	...
	public static void application() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else if (passwordField.getText().equals("user123") && (txtUsername.getText().equals("emp1")
		...
		btnNext.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					try
					{
						Integer ISBN=Integer.valueOf(textField_5.getText());
						if(!new BookDao().doesBookExist(ISBN))
						{
						...
						else
						{
							...
							if(thebook.getNoOfCopies()< Integer.valueOf(textField_7.getText()))
							{
