...
public class Interface_final {
	...
	public static void application() {
		...
		queryBookList.setBounds(116, 127, 437, 261);
		...
		JPanel belowThresholdPanel = new JPanel(new GridLayout());
		...
		lblViewList.setBounds(190, 54, 295, 14);
		belowThresholdPanel.add(lblViewList);

		JTextArea textArea_threshold = new JTextArea();
		textArea_threshold.setBounds(162, 92, 369, 310);
		textArea_threshold.setLineWrap(true);

		belowThresholdPanel.add(textArea_threshold);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ownerPanel.setVisible(true); //RB123
		...
		btnGenerateReceipt.setBounds(288, 357, 129, 34);
	...
	public static void main(String[] args) {
		...
		/*
		 * Book book1=new Book(); book1.setISBN(11223); book1.setNoOfCopies(0);
		 * book1.setBookTitle("Hey"); book1.setAuthorName("Lama");
		 * book1.setPrice(12); book1.setRackNo(12); book1.setThreshold(12);
