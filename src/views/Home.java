...
public class Home {
	...
	public static void application() {
		...
		lblAuthorName.setBounds(190, 265, 150, 14);
		viewBook.add(lblAuthorName);

		JLabel lblPrice = new JLabel("Price : ");
		lblPrice.setBounds(190, 298, 120, 14);
		viewBook.add(lblPrice);

		JLabel lblNoOfCopies = new JLabel("Number of copies : ");
		lblNoOfCopies.setBounds(190, 334, 150, 14);
		...
		tfSearchByAuthor.setBounds(163, 78, 235, 20);
